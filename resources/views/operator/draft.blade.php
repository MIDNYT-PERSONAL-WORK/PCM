        ...
        <div class="flex flex-col flex-1 overflow-hidden">
            ...
            <div class="flex items-center justify-between px-6 py-3 bg-white border-b border-pam-gray-light">
                <div class="flex items-center">
                    <h1 class="text-xl font-semibold text-pam-gray">Draft Orders</h1>
                </div>
            ...
            <div class="flex-1 overflow-y-auto p-4 md:p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                    <div class="bg-white p-4 rounded-lg shadow-sm border border-pam-gray-light">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-sm font-medium text-pam-gray">Total Draft Orders</p>
                                <p class="text-2xl font-semibold text-pam-blue">{{$TotalDraft}}</p>
                                <p class="text-xs text-pam-gray">All draft orders</p>
                            </div>
                    ...
                    <div class="bg-white p-4 rounded-lg shadow-sm border border-pam-gray-light">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-sm font-medium text-pam-gray">Today's Drafts</p>
                    ...
                    <div class="bg-white p-4 rounded-lg shadow-sm border border-pam-gray-light">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-2xl font-semibold text-pam-blue">{{$avgDraftAgeHours}}</p>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
                    ...
                    <div class="bg-white p-4 rounded-lg shadow-sm border border-pam-gray-light">
                        <h2 class="text-lg font-medium text-pam-gray mb-4">Draft Status</h2>
                        <div class="h-64">
                ...
                <!-- Draft Orders Table -->
                    ...
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                        <h2 class="text-lg font-medium text-pam-gray mb-2 md:mb-0">All Draft Orders</h2>
                        ...
                        <table class="min-w-full divide-y divide-pam-gray-light">
                            ...
                            <tbody class="bg-white divide-y divide-pam-gray-light">
                                ...
                                <tr class="hover:bg-pam-gray-light/50">
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-pam-blue">DRAFT-{{ $draft->id }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-pam-gray">
                                        {{ $draft->customer_name }}<br>
                                        <span class="text-xs text-black">{{ $draft->phone }}</span>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-pam-gray">
                                        @if($draft->items->isNotEmpty())
                                            {{ $draft->items->first()->product->vendor->name ?? 'N/A' }}
                                        @else
                                            N/A
                                        @endif
                                    </td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-pam-gray">
                                        ${{ number_format($draft->items->sum('amount'), 2) }}
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-pam-gray">
                                        {{ $draft->created_at->diffForHumans() }}<br>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        @endphp
                                        <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full {{ $statusClasses[$draft->status] ?? 'bg-pam-gray-100 text-pam-gray-800' }}">
                                            {{ ucfirst(str_replace('_', ' ', $draft->status)) }}
                                        </span>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <a href="{{ route('drafts.edit', $draft->id) }}" 
                                            class="text-pam-blue-light hover:text-pam-blue mr-3">Edit</a>
                                        <button class="text-pam-green hover:text-pam-green">Confirm</button>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
