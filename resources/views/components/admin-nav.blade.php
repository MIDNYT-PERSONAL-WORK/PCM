...
<head>
    ...
    <title>Admin | PAM Logistics</title>
    ...
    <div class="flex h-screen" x-data="{ mobileMenuOpen: false, profileDropdownOpen: false }">
        ...
        <div id="sidebar" 
            ...
            <div class="flex flex-col h-full border-r border-gray-200">
                ...
                <div class="flex flex-col flex-grow px-4 py-4 overflow-y-auto">
                    <nav class="space-y-1">
                        <a href="{{route('admin.dashboard')}}" class="flex items-center px-2 py-3 text-sm font-medium rounded-md {{ request()->routeIs('admin.dashboard') ? 'bg-pam-blue text-white' : 'text-pam-gray hover:bg-pam-gray-light hover:text-pam-blue' }}">
                            <svg class="mr-3 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                            </svg>
                            Dashboard
                        </a>
                        <a href="{{route('admin.roles.page')}}" class="flex items-center px-2 py-3 text-sm font-medium rounded-md {{ request()->routeIs('admin.roles.page') ? 'bg-pam-blue text-white' : 'text-pam-gray hover:bg-pam-gray-light hover:text-pam-blue' }}">
                            <svg class="mr-3 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                            </svg>
                            Roles
                        </a>
                        <a href="{{route('admin.customer')}}" class="flex items-center px-2 py-3 text-sm font-medium rounded-md {{ request()->routeIs('admin.customer') ? 'bg-pam-blue text-white' : 'text-pam-gray hover:bg-pam-gray-light hover:text-pam-blue' }}">
                            <svg class="mr-3 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                            </svg>
                            Customers
                        </a>
                        <a href="{{route('admin.vendor')}}" class="flex items-center px-2 py-3 text-sm font-medium rounded-md {{ request()->routeIs('admin.vendor') ? 'bg-pam-blue text-white' : 'text-pam-gray hover:bg-pam-gray-light hover:text-pam-blue' }}">
                            <svg class="mr-3 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
                            </svg>
                            Vendors
                        </a>
                        <a href="{{route('admin.inventory')}}" class="flex items-center px-2 py-3 text-sm font-medium rounded-md text-pam-gray hover:bg-pam-gray-light hover:text-pam-blue">
                            <svg class="mr-3 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
                            </svg>
                            Inventory
                        </a>
                        <a href="{{route('admin.order')}}" class="flex items-center px-2 py-3 text-sm font-medium rounded-md {{ request()->routeIs('admin.order') ? 'bg-pam-blue text-white' : 'text-pam-gray hover:bg-pam-gray-light hover:text-pam-blue' }}">
                            <svg class="mr-3 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="flex flex-col flex-1 overflow-hidden">
            ...
            <div class="hidden md:flex items-center justify-between px-6 py-3 bg-white border-b border-pam-gray-light">
                <div class="flex items-center">
                    <h1 class="text-xl font-semibold text-pam-gray">Admin Dashboard</h1>
                </div>
                <div class="flex items-center space-x-4">
                    <div class="relative">
