...
<head>
    ...
    <title>🏍️ Rider | PAM Logistics</title>
            ...
            <div class="flex flex-col h-full border-r border-gray-200">
                ...
                <div class="flex items-center justify-center h-16 px-4 border-b border-gray-200">
                    <div class="flex items-center">
                        ...
                        <span class="text-xl font-semibold text-pam-blue">RIDER Management</span>
                    </div>
                </div>
                ...
                <div class="flex flex-col flex-grow px-4 py-4 overflow-y-auto">
                    <nav class="space-y-1">
                        ...
                        class="flex items-center px-2 py-3 text-sm font-medium rounded-md 
                                {{ request()->routeIs('rider.dashboard') ? 'bg-pam-blue-light text-white' : 'text-pam-gray hover:bg-pam-gray-light hover:text-pam-blue' }}">
                            <svg class="mr-3 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                            </svg>
                            Dashboard
                        </a>
                        <a href="{{route('rider.delivery')}}" 
                        class="flex items-center px-2 py-3 text-sm font-medium rounded-md 
                                {{ request()->routeIs('rider.delivery') ? 'bg-pam-blue-light text-white' : 'text-pam-gray hover:bg-pam-gray-light hover:text-pam-blue' }}">
                            <svg class="mr-3 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        class="flex items-center px-2 py-3 text-sm font-medium rounded-md 
                                {{ request()->routeIs('rider.performance') ? 'bg-pam-blue-light text-white' : 'text-pam-gray hover:bg-pam-gray-light hover:text-pam-blue' }}">
                            <svg class="mr-3 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" />
                            </svg>
                            Performance
                        </a>
                        <a href="{{route('rider.payment')}}" 
                        class="flex items-center px-2 py-3 text-sm font-medium rounded-md 
                                {{ request()->routeIs('rider.payment') ? 'bg-pam-blue-light text-white' : 'text-pam-gray hover:bg-pam-gray-light hover:text-pam-blue' }}">
                            <svg class="mr-3 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
